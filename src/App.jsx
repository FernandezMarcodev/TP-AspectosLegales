...
const roscoDatos = [
  ...
  { letra: 'E', definicion: 'Derecho que otorga el estado para ser el único que puede usar comercialmente una marca', respuesta: 'Exclusividad' },
  { letra: 'F', definicion: 'Apellido del reconocido médico argentino que desarrolló la técnica del bypass coronario', respuesta: 'Favaloro' },
  { letra: 'G', definicion: 'Función de la marca que le asegura al cliente que el producto tendrá la misma calidad que en compras anteriores', respuesta: 'Garantía' },
  { letra: 'H', definicion: 'Nombre del licor que fue la primera marca comercial registrada en Argentina', respuesta: 'Hesperidina' },
  { letra: 'I', definicion: 'Siglas del instituto donde se realizan todos los trámites para proteger marcas y patentes en el país', respuesta: 'INPI' },
  { letra: 'J', definicion: 'Objeto que Carlos Arcusín rediseñó para que fueran autodescartables y no se pudieran reutilizar', respuesta: 'Jeringas' },
  { letra: 'K', definicion: '(Contiente K); Marca de ropa y calzado deportivo usada como ejemplo en los textos para explicar cómo funcionan las marcas', respuesta: 'Nike' },
  { letra: 'L', definicion: 'Contrato por el cual el dueño de una patente le permite a otra persona usar su invento a cambio de un pago', respuesta: 'Licencia' },
  { letra: 'M', definicion: 'Todo signo o nombre que sirve para distinguir productos y servicios en el mercado', respuesta: 'Marca' },
  { letra: 'N', definicion: 'Requisito de las patentes que exige que el invento no haya sido mostrado o publicado antes en ningún lugar del mundo', respuesta: 'Novedad' },
  { letra: 'O', definicion: 'Trámite que puede hacer una persona si cree que una marca nueva es demasiado parecida a la que ya tiene', respuesta: 'Oposición' },
  { letra: 'P', definicion: 'Título que da el Estado por 20 años para proteger un invento y evitar que otros lo copien sin permiso', respuesta: 'Patente' },
  { letra: 'Q', definicion: 'Inventor argentino que fue pionero mundial en el cine de animación usando figuras articuladas', respuesta: 'Quirino Cristiani' },
  { letra: 'R', definicion: 'Acto fundamental para obtener la propiedad de una marca; en Argentina, si no la registras, no es tuya', respuesta: 'Registro' },
  { letra: 'S', definicion: 'Tipo de creación que no se puede patentar en Argentina, ya que se protege como derecho de autor', respuesta: 'Software' },
  { letra: 'T', definicion: 'Regla que dice que la protección de tu marca o patente solo es válida dentro del país donde la registraste', respuesta: 'Territorialidad' },
  { letra: 'U', definicion: 'Es obligatorio para mantener una marca; si no se usa de forma efectiva, se puede perder el derecho', respuesta: 'Uso' },
  { letra: 'V', definicion: 'Apellido del creador del sistema para identificar personas a través de sus huellas dactilares', respuesta: 'Vucetich' },
  { letra: 'W', definicion: 'Ejemplo de marca de certificación que garantiza que un producto está hecho con lana pura', respuesta: 'Woolmark' },
  { letra: 'X', definicion: '(Contiene X); Término que se usa cuando se terminan los derechos sobre una marca o patente, por ejemplo, por vencimiento', respuesta: 'Extinción' },
  { letra: 'Y', definicion: 'Producto que se usa de ejemplo para explicar cómo varios productores podrían usar una misma marca colectiva', respuesta: 'Yerba' },
  { letra: 'Z', definicion: 'Tipo de calzado que se usa de ejemplo para explicar que no se puede registrar una marca como "MIKE" por ser casi igual a Nike', respuesta: 'Zapatillas' },
]
